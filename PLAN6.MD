...
POST http://localhost:5000/mission/start
...
### Get mission status
GET http://localhost:5000/mission/status/mission-CLEANUP-LEO-001

### Get agent decision history
GET http://localhost:5000/mission/mission-CLEANUP-LEO-001/decisions
```
