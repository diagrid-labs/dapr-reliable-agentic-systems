...
public class GenerateReportActivity : WorkflowActivity<GenerateReportInput, string>
{
    public override Task<string> RunAsync(
        WorkflowActivityContext context,
        GenerateReportInput input)
    {
        var agentState = input.AgentState;
        var decisions = input.Decisions;
        var toolCalls = input.ToolCalls;
